...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.source           = { :git => 'https://abenergie.visualstudio.com/_git/ABcommon.ios', :tag => 'v1.3.8' }
  ...
  s.subspec 'BottomSheet' do |bottomSheet|
    bottomSheet.source_files = 'Source/BottomSheet/*.{swift,xcassets}'
    bottomSheet.resources = 'Source/BottomSheet/*.xcassets'
  end
