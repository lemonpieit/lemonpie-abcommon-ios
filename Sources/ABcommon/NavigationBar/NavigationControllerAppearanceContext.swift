...
public typealias NavBarAppearanceContext = NavigationControllerAppearanceContext

/// Conform to `NavigationControllerAppearanceContext` to define the behaviour of the `UINavigationBar` and `UIToolbar`.
@available(*, deprecated, renamed: "NavBarAppearanceContext")
public protocol NavigationControllerAppearanceContext: AnyObject {
...
public extension NavigationControllerAppearanceContext {
  ...
  var shadowMode: ShadowMode {
    return NavBarAppearance.shadowMode
  }
  ...
  func largeTitleDisplayMode(for navigationController: UINavigationController) -> UINavigationItem.LargeTitleDisplayMode {
    return NavBarAppearance.defaultDisplayMode
  }
  ...
  func preferredAppearance(for navigationController: UINavigationController) -> NavBarAppearance? {
    return NavBarAppearance.defaultAppearance
  }
