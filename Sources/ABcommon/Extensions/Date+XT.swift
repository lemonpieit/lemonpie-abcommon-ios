...
public extension Date {
  ...
  func isInTheSameMonth(of date: Date) -> Bool {
    self.component(.month) == date.component(.month)
  }
  
  /// Compares two date and returns whether is the same year.
  /// - Parameter date: The date to compare.
  func isInTheSameYear(of date: Date) -> Bool {
    self.component(.year) == date.component(.year)
  }
  
  /// Compares two date and returns whether is the same month and year.
  /// - Parameter date: The date to compare.
  func isInTheSameMonthYear(of date: Date) -> Bool {
    isInTheSameYear(of: date) && isInTheSameMonth(of: date)
  }
